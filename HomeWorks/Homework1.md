# Homework 1
### Description: create a language for users of the set theory to evaluate binary operations on sets using variables and scopes where elements of the sets can be objects of any type.
### Grade: 10%

## Preliminaries
As part of this homework assignment you will gain experience with creating and managing your Git repository, implementing your first domain-specific language using Scala for writing and evaluating for users of the [set theory](https://en.wikipedia.org/wiki/Set_theory) to evaluate [binary operations on sets](https://images-na.ssl-images-amazon.com/images/G/31/img15/books/tiles/9352036042_chemistry.pdf) using variables and scopes where elements of the sets can be objects of any type, creating [Scalatest](https://www.scalatest.org/) tests, and creating your [SBT build and run scripts](https://www.scala-sbt.org/) for your language project. Feel free to come up with some cute name for your language. Doing this homework is essential for successful completion of the rest of this course, since all other homeworks and the course project will share the same features of this homework: branching, merging, committing, pushing your code into your Git repo, creating test cases and build scripts, and using various tools like a debugger for diagnosing problems with your applications.
